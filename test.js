...
setTimeout(() => {
    ...
    var insights_Url= document.querySelector('div.mic-insights-url input').value;
    ...
    var insights= document.querySelector("mic-insights");
    ...
    insights.setAttribute("url",insights_Url);
    insights.setAttribute("token",token);
