...
<script>
  ...
  /**
   * @type {string} jwt token generated by MiPortal
   */
  export let token;
  /**
   * @type {string} the environment domain (Dev, Qa, Prod)
   */
  export let domain;
  /**
  ...
  export let personainput;
    /**
   * @type {string} SAP credintials
   */
  export let saptoken = '""';
    /**
   * @type {string} the flag that determine the type of registered account
   */
